const chefReceived = (orderNumber) => new Promise((resolve, reject) => {
		setTimeout(() => {
...
const pizzaSauceAdded = (orderNumber) => new Promise((resolve, reject) => {
		setTimeout(() => {
...
const firstLayerOfCheezeAdded = (orderNumber) => new Promise((resolve, reject) => {
		setTimeout(() => {
...
const toppingsAdded = (orderNumber) => new Promise((resolve, reject) => {
		setTimeout(() => {
...
const secondLayerOfCheezeAdded = (orderNumber) => new Promise((resolve, reject) => {
		setTimeout(() => {
...
const pizzaBaked = (orderNumber) => new Promise((resolve, reject) => {
		setTimeout(() => {
...
const oreganoAdded = (orderNumber) => new Promise((resolve, reject) => {
		setTimeout(() => {
...
const packageReceivedAtCounter = (orderNumber) => new Promise((resolve, reject) => {
		setTimeout(() => {
